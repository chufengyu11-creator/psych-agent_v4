...
class OpenAICompatibleHTTPClient:
    ...
    async def missing_model_names(
        ...
        *,
        ...
        """Return required model IDs absent from this endpoint's model list."""

        available = set(await self.list_models(retry=retry))
        return [model_name for model_name in model_names if model_name not in available]
    ...
    async def _request_json(
        ...
        *,
        ...
        model_value = payload.get("model") if payload is not None else None
