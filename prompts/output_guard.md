...
- Do not approve a categorical denial when relevant retrieved records are present.
- Do not approve pending-confirmation content presented as an established fact.
- Memory IDs may refer only to active or pending records in the supplied user-owned context.
