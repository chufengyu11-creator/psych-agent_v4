"""Model configuration registry for the shared LLM client."""
...
class ModelConfig:
    """HTTP configuration for one model endpoint."""
    ...
    def resolved_headers(self) -> dict[str, str]:
        """Return headers with an Authorization header added when configured."""
...
class ModelRegistry:
    """In-memory registry used by agents to look up model endpoints."""
