...
Only RiskAgent, StateTracker, and StrategyPlanner use the structured model in
this stage. ResponseAgent, OutputGuard, and FeedbackEvaluator remain their
existing deterministic implementations. The task queue remains `NoopTaskQueue`.
